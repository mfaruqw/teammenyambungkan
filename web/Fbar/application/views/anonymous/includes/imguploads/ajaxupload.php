...
$path = "../../img/tempat/"; //set your folder path
...
$valid_formats = array("jpg", "png", "gif", "bmp", "jpeg","GIF","JPG","PNG"); //add the formats you want to upload
		...
		if(strlen($name)) //check if the file is selected or cancelled after pressing the browse button. 
		{
			...
			{
			$actual_image_name =  str_replace(" ", "_", $txt)."_".date ('dmY').".".$ext; //actual image name going to store in your folder
			...
			if(move_uploaded_file($tmp, $path.$actual_image_name)) //check the path if it is fine
				{
					...
					echo "<img src='../../img/tempat/".$actual_image_name."'  class='preview' width='200px' height='200px'> <br><input type='hidden' name='actual_image_name' id='actual_image_name' value='$actual_image_name' />";
					?><br />
